...
import com.domoffon.efremov.domoffon.wizard.model.ReviewItem;
...
public class ReviewFragment extends ListFragment implements ModelCallbacks {
    ...
    public class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
            ...
            if (reviewItem.getTitle().contains("ШАГ")) {
                ((TextView) rootView.findViewById(android.R.id.text1)).setText("Адрес доставки");
                mInfo.put("addr", value);
            }
            else{
                ((TextView) rootView.findViewById(android.R.id.text1)).setText(reviewItem.getTitle());
                mInfo.put(reviewItem.getTitle(), value);
            }
