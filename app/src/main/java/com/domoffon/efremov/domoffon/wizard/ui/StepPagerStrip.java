...
public class StepPagerStrip extends View {
    ...
    public StepPagerStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPrevTabPaint.setColor(res.getColor(R.color.colorAccent));

        mSelectedTabPaint = new Paint();
        mSelectedTabPaint.setColor(res.getColor(R.color.primary_material_light_1));

        mSelectedLastTabPaint = new Paint();
        mSelectedLastTabPaint.setColor(res.getColor(R.color.primary_material_light_1));
